...
urlpatterns = [
    ...
    path('deliverables/submissions/<id>/link-attachments/', views.LinkAttachment_view),
    path('deliverables/submissions/<id>/link-attachments/<LAid>', views.LinkAttachment_view)
]
